...
public:
    struct VectorRecord
    {
        ...
        VectorRecord(int id, const string &rawText, SinglyLinkedList<float> *vector): id(id), rawText(rawText) , rawLength(vector->size()), vector(vector) {}
    };
...
public:
    ...
    void kiemtraIndex(int index) const {
    ...
    VectorRecord* getRecord(int index) const;
